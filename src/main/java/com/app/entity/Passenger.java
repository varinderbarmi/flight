 ...
 * 
 * @Entity public class Passenger { String name; String email; String gender;
 * int age; public Passenger(String name, String email, String gender, int age)
 * { super(); this.name = name; this.email = email; this.gender = gender;
 ...
 * 
 * @Override public String toString() { return "Passenger [name=" + name +
 * ", email=" + email + ", gender=" + gender + ", age=" + age + "]"; }
 * 
 * @Override public int hashCode() { return Objects.hash(age, email, gender,
 * name); }
 * 
 * @Override public boolean equals(Object obj) { if (this == obj) return true;
 * if (obj == null) return false; if (getClass() != obj.getClass()) return
 * false; Passenger other = (Passenger) obj; return age == other.age &&
